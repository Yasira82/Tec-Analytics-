 ...
 * foreign). Two signals — the sessionStorage flag persisted by the SSO landing
 * (the C-123 LAW-2 landing erases the hub referrer via location.replace), with
 * document.referrer as fallback for direct hub→app hops.
 */
